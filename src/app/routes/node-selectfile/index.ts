...
export class NodeSelectfileComponent implements OnInit {
    ...
    selectColumn: SimpleTableColumn[] = [
        { title: 'Numbering', index: 'id', type: 'checkbox', className: 'text-center' },
        { title: 'Serial number', index: 'id', className: 'text-center' },
        { title: 'file name', index: 'name', click: (item: any) => this.msg.success(item.name), className: 'text-center' },
